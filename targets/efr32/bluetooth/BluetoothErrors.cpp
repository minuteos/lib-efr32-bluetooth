...
static errmsg_t s_errors3[] = { "passkey_entry_failed", "oob_not_available", "authentication_requirements", "confirm_value_failed", "pairing_not_supported", "encryption_key_size", "command_not_supported", "unspecified_reason", "repeated_attempts", "invalid_parameters", "dhkey_check_failed", "numeric_comparison_failed", "bredr_pairing_in_progress", "cross_transport_key_derivation_generation_not_allowed" };
static errmsg_t s_errors4[] = { "invalid_handle", "read_not_permitted", "write_not_permitted", "invalid_pdu", "insufficient_authentication", "request_not_supported", "invalid_offset", "insufficient_authorization", "prepare_queue_full", "att_not_found", "att_not_long", "insufficient_enc_key_size", "invalid_att_length", "unlikely_error", "insufficient_encryption", "unsupported_group_type", "insufficient_resources" };
static errmsg_t s_errors5[] = { "ps_store_full", "ps_key_not_found", "i2c_ack_missing", "i2c_timeout" };
static errmsg_t s_errors9[] = { "file_not_found" };
static errmsg_t s_errors10[] = { "file_open_failed", "xml_parse_failed", "device_connection_failed", "device_comunication_failed", "authentication_failed", "incorrect_gatt_database", "disconnected_due_to_procedure_collision", "disconnected_due_to_secure_session_failed", "encryption_decryption_error", "maximum_retries", "data_parse_failed", "pairing_removed", "inactive_timeout" };
static errmsg_t s_errors11[] = { "image_signature_verification_failed", "file_signature_verification_failed", "image_checksum_error" };
static errmsg_t s_errors12[] = { "already_exists", "does_not_exist", "limit_reached", "invalid_address", "malformed_data" };

static const errtable_t s_errors[] = {
    s_errors1,
    s_errors2,
    s_errors3,
    s_errors4,
